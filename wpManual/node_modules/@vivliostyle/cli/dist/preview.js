...
import { cwd, debug, isUrlString, logSuccess, logUpdate, pathContains, pathEquals, runExitHandlers, setLogLevel, startLogging, upath, } from './util.js';
let timer;
    ...
    watcher = chokidar
        ...
        ignored: (path) => {
            ...
            if (config.entries.length &&
                ...
                !config.entries.some((entry) => entry.rel !== 'contents' &&
                    pathEquals(path, entry.source))) {
