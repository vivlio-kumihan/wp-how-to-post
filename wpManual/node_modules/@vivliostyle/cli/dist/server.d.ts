...
export declare function getViewerFullUrl({ size, cropMarks, bleed, cropOffset, css, style, userStyle, singleDoc, quick, viewerParam, }: ViewerUrlOption, { viewerUrl, sourceUrl }: {
    viewerUrl: URL;
    sourceUrl: URL;
}): string;
