module.exports = {
  title: 'wpManual', // populated into `publication.json`, default to `title` of the first entry or `name` in `package.json`.
  author: 'Nobuyuki Takahiro <vivlio@kumihan.com>', // default to `author` in `package.json` or undefined.
  // language: 'ja', // default to undefined.
  // size: 'A4', // paper size.
  theme: '@vivliostyle/theme-academic@^1.0.0', // .css or local dir or npm package. default to undefined.
  entry: [
